...
$save = function(){
    ...
    $validated = $this->validate([
        ...
        'license_no_plate' => [ 'required',
                                'regex:/^[A-Z0-9]+$/i',
                                'unique:vehicles,license_no_plate',
                                'max:15',
                                ],
        'color' => ['required', 'regex:/^[\pL\s]+$/u', 'string', 'min:2', 'max:50'],
        'max_capacity' => ['required', 'integer', 'min:1', 'max:100'],
        'uploadVehiclePhotos.*' => ['required', 'image','mimes:jpeg,png,jpg','max:10000'],
        'uploadVehicleLicensePhotos.*' => ['required', 'image','mimes:jpeg,png,jpg','max:10000'],
