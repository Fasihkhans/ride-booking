...
{{-- <div> --}}
                    ...
                    <div class="items-center justify-center w-full md:flex md:w-auto md:order-1 " id="navbar-sticky" hidden>

                        <div class="flex justify-center w-full">
                            <a href="/help"><button type="button" class="px-4 py-2 mx-2 text-sm font-medium text-center text-white bg-black border border-white rounded-lg md:hidden hover:bg-black hover:text-white focus:ring-4 focus:outline-none focus:ring-blue-300 ">Help</button></a>
                            ...
                            @auth
                                ...
                                <a href="{{ route('customer-home') }}"><button type="button" class="px-4 py-2 mx-2 text-sm font-medium text-center text-black bg-white border border-white rounded-lg md:hidden hover:bg-black hover:text-white focus:ring-4 focus:outline-none focus:ring-blue-300">Dasboard</button></a>
                            @endauth
                            @guest
