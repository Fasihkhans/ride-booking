...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
                    ...
                    <div class="text-sm text-center text-gray-500 dark:text-gray-400 sm:text-start">
                        <div class="flex items-center gap-4">
                            <a href="https://github.com/sponsors/taylorotwell" class="inline-flex items-center group hover:text-gray-700 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" class="w-5 h-5 -mt-px me-1 stroke-gray-400 dark:stroke-gray-600 group-hover:stroke-gray-600 dark:group-hover:stroke-gray-400">
    ...
    {{-- <body> --}}
<x-web-layout>
    <div class="w-[1440px] h-[2394px] relative bg-white">
        <img class="w-[1440px] h-[768px] left-0 top-0 absolute" src="https://via.placeholder.com/1440x768" />
        <div class="w-[1440px] h-[72px] left-0 top-0 absolute bg-black"></div>
        <div class="w-[171px] h-12 px-[8.49px] py-[8.56px] left-[80px] top-[12px] absolute justify-center items-center inline-flex">
        ...
        <div class="w-[68px] px-[21px] py-[17px] left-[1292px] top-[12px] absolute bg-white rounded-[10px] justify-center items-center gap-2.5 inline-flex">
            <div class="text-center text-black text-sm font-bold font-['Outfit'] leading-[14px]">Signup</div>
        </div>
        <div class="w-[124px] px-[21px] py-[17px] left-[88px] top-[624px] absolute bg-white rounded-[10px] justify-center items-center gap-2.5 inline-flex">
            <div class="text-center text-black text-sm font-bold font-['Outfit'] leading-[14px]">Apply to drive</div>
        </div>
        <div class="w-[68px] px-[21px] py-[17px] left-[1211px] top-[12px] absolute rounded-[10px] border-2 border-white justify-center items-center gap-2.5 inline-flex">
            <div class="text-center text-white text-sm font-bold font-['Outfit'] leading-[14px]">Login</div>
        </div>
        <div class="left-[291px] top-[29px] absolute text-center text-white text-sm font-bold font-['Outfit'] leading-[14px]">Company</div>
        <div class="left-[395px] top-[29px] absolute text-center text-white text-sm font-bold font-['Outfit'] leading-[14px]">Safety</div>
        <div class="left-[478px] top-[29px] absolute text-center text-white text-sm font-bold font-['Outfit'] leading-[14px]">Help</div>
        <div class="w-[883px] left-[80px] top-[384px] absolute text-white text-[88px] font-normal font-['Outfit'] leading-[88px]">Get in the driver’s seat and get paid</div>
        <div class="w-[1080px] left-[80px] top-[848px] absolute text-black text-[56px] font-normal font-['Outfit'] leading-[56px]">Focused on safety, wherever you go</div>
        <div class="left-[80px] top-[584px] absolute text-white text-2xl font-normal font-['Outfit'] leading-normal">Drive on the platform with the largest network of active riders.</div>
