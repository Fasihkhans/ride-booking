    ...
    <div class="relative w-full h-auto bg-white">
            ...
            <section class="bg-gray-700 bg-center bg-no-repeat " style="background-image: url('{{ asset('assets/png/landingPageS1.png') }}');">
                <div class="max-w-screen-xl px-4 py-24 mx-auto text-left lg:py-56">
                    <h1 class="mb-4 text-4xl font-extrabold leading-none tracking-tight text-white md:text-5xl lg:text-6xl font-['Outfit']">Get in the driver’s seat and get paid</h1>
                    <p class="mb-8 text-lg font-normal text-gray-300 lg:text-xl sm:px-16 lg:px-2 font-['Outfit']">Drive on the platform with the largest network of active riders.</p>
                    <div class="flex flex-col space-y-4 sm:flex-row sm:justify-start sm:space-y-0">
                        <a href="#" class="inline-flex items-center justify-center px-5 py-3 text-base  font-['Outfit'] font-medium text-center text-black bg-white rounded-lg hover:bg-black hover:border-white border hover:text-white focus:ring-4 focus:ring-blue-300 dark:focus:ring-blue-900">
                            Apply to drive
            ...
            <section class="bg-white dark:bg-gray-900">
                <div class="max-w-screen-xl px-4 py-8 mx-auto lg:py-16">
                    {{-- <div class="p-8 mb-8 border border-gray-200 rounded-lg bg-gray-50 dark:bg-gray-800 dark:border-gray-700 md:p-12"> --}}
                        ...
                        <h1 class="text-gray-900 mb-4 dark:text-white text-3xl md:text-5xl font-extrabold font-['Outfit']">Focused on safety, wherever you go</h1>
                    ...
                    <div class="grid gap-8 md:grid-cols-2">
                        <div class="rounded-lg dark:bg-gray-800 dark:border-gray-700">
                            ...
                            <div class="py-5">
                                <h2 class="mb-2 text-3xl font-extrabold text-gray-900 dark:text-white">Our commitment to your safety</h2>
                                <p class="mb-4 text-lg font-normal text-gray-500 dark:text-gray-400">With every safety feature and every standard in our Community Guidelines, we're committed to helping to create a safe environment for our users.</p>
                                <a href="#" class="inline-flex items-center text-lg font-medium text-blue-600 dark:text-blue-500 hover:underline">Learn more
                                    <svg class="w-3.5 h-3.5 ms-2 rtl:rotate-180" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 10">
                                    <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M1 5h12m0 0L9 1m4 4L9 9"/>
                                </svg>
                                </a>
                        ...
                        <div class="rounded-lg dark:bg-gray-800 dark:border-gray-700">
                            ...
                            <div class="py-5">
                                <h2 class="mb-2 text-3xl font-extrabold text-gray-900 dark:text-white">Setting Darlington in motion</h2>
                                <p class="mb-4 text-lg font-normal text-gray-500 dark:text-gray-400">The app is available in darlington, so you can request a ride even when you’re far from home.</p>
                                <a href="#" class="inline-flex items-center text-lg font-medium text-blue-600 dark:text-blue-500 hover:underline">Learn more
                                    <svg class="w-3.5 h-3.5 ms-2 rtl:rotate-180" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 10">
                                    <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M1 5h12m0 0L9 1m4 4L9 9"/>
                                </svg>
                ...
                <div class="max-w-screen-xl px-4 py-8 mx-auto lg:py-16">
                    <div class="grid gap-8 md:grid-cols-3">
                        <div class="rounded-lg dark:bg-gray-800 dark:border-gray-700">
                            ...
                            <div class="py-5">
                                <h2 class="mb-2 text-3xl font-extrabold text-gray-900 dark:text-white">About us</h2>
                                <p class="mb-4 text-lg font-normal text-gray-500 dark:text-gray-400">Find out how we started, what drives us, and how we’re reimagining how the world moves.</p>
                                <a href="#" class="inline-flex items-center text-lg font-medium text-blue-600 dark:text-blue-500 hover:underline">Learn more about us
                                    <svg class="w-3.5 h-3.5 ms-2 rtl:rotate-180" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 10">
                                    <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M1 5h12m0 0L9 1m4 4L9 9"/>
                                </svg>
                                </a>
                        ...
                        <div class="rounded-lg dark:bg-gray-800 dark:border-gray-700">
                            ...
                            <div class="py-5">
                                <h2 class="mb-2 text-3xl font-extrabold text-gray-900 dark:text-white">Newsroom</h2>
                                <p class="mb-4 text-lg font-normal text-gray-500 dark:text-gray-400">Find out how we started, what drives us, and how we’re reimagining how the world moves.</p>
                                <a href="#" class="inline-flex items-center text-lg font-medium text-blue-600 dark:text-blue-500 hover:underline">Learn more about us
                                    <svg class="w-3.5 h-3.5 ms-2 rtl:rotate-180" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 10">
                                    <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M1 5h12m0 0L9 1m4 4L9 9"/>
                        ...
                        <div class="rounded-lg dark:bg-gray-800 dark:border-gray-700">
                            ...
                            <div class="py-5">
                                <h2 class="mb-2 text-3xl font-extrabold text-gray-900 dark:text-white">Global citizenship</h2>
                                <p class="mb-4 text-lg font-normal text-gray-500 dark:text-gray-400">Find out how we started, what drives us, and how we’re reimagining how the world moves.</p>
                                <a href="#" class="inline-flex items-center text-lg font-medium text-blue-600 dark:text-blue-500 hover:underline">Learn more about us
                                    <svg class="w-3.5 h-3.5 ms-2 rtl:rotate-180" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 10">
                                    <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M1 5h12m0 0L9 1m4 4L9 9"/>
            ...
            <section class="bg-white dark:bg-gray-900">
                <div class="max-w-screen-xl px-4 py-8 mx-auto lg:py-16">
                    <div class="grid gap-8 md:grid-cols-2">
                        <div class="relative bg-black border-b-8 border-black rounded-lg dark:bg-gray-800 dark:border-gray-700 bg-opacity-5">
                            <div class="inline-flex text-black text-5xl py-8 px-4 font-semibold font-['Outfit'] leading-[56px]">Apply to drive</div>
                            <svg class="md:flex absolute  top-[2.5rem] right-[2rem] w-[3rem] h-[3rem] hidden md:order-1 text-black dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 10">
                                <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M1 5h12m0 0L9 1m4 4L9 9"></path>
                            </svg>
                        </div>
                        <div class="relative align-middle bg-black border-b-8 border-black rounded-lg dark:bg-gray-800 dark:border-gray-700 bg-opacity-5">
