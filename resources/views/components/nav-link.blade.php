...
$classes = ($active ?? false)
            ? $commonClass.' text-white  text-gray-900  focus:outline-none focus:border-indigo-700'
            : $commonClass.' text-black border-transparent text-gray-500  hover:text-gray-700  hover:border-gray-300  focus:outline-none focus:text-gray-700  focus:border-gray-300 ';
