...
$styles = ($active ?? false)
            ?  'color:#fff !important; border-radius: 1.25rem; background: var(--3, #303030);
                width: 14.6875rem;
                height: 3.1875rem;
                flex-shrink: 0;
                font-size: 1rem;
...
<a {{ $attributes->merge(['class' => $classes, 'style'=> $styles]) }} >
    <svg xmlns="http://www.w3.org/2000/svg" width="14" height="16" viewBox="0 0 14 16" fill="none" class="m-2">
